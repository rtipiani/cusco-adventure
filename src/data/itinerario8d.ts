    ...
    [
        {
            ...
            imagen: "/cusco/city-tour-en-la-ciudad-de-los-incas.avif"
        },
        {
            dia: "TOUR VALLE SAGRADO DE LOS INCAS + MARAS Y MORAY",
            descripcion: [
            ...
            imagen: "/cusco/maras-y-moray-de-los-incas.avif"
        },
        {
            ...
            imagen: "/cusco/tour-desde-cusco-a-machu-picchu.avif"
        },
        {
            ...
            imagen: "/cusco/tour-montana-de-7-colores-vinicunca.avif",
        },
        {
            dia: "TOUR LAGUNA HUMANTAY",
            descripcion: [
                `Descubre la mágica Laguna Humantay, una de las joyas naturales más visitadas de Cusco. Nuestro tour inicia muy temprano con el recojo en tu hotel (04:30 – 05:00 a.m.) para dirigirnos hacia Mollepata, donde disfrutaremos de un desayuno buffet.`,
                `Luego continuaremos hasta Soraypampa (3900 m.s.n.m.), punto de inicio de la caminata. El trekking de aproximadamente 1 hora y 30 minutos nos llevará hasta la impresionante Laguna Humantay (4200 m.s.n.m.), de aguas turquesa rodeada por imponentes glaciares de la Cordillera de los Andes. Después de la visita retornaremos a Mollepata para almorzar antes de regresar a Cusco.`
            ],
            incluye: ["Transporte turístico ida y retorno", "Desayuno y almuerzo buffet", "Tickets de ingreso", "Guía profesional bilingüe"],
            noIncluye: ["Renta de caballos", "Gastos personales"],
            recomendaciones: [
                "Pasaporte o DNI vigente",
                "Mochila pequeña, agua y snacks",
            ...
            imagen: "/cusco/tour-laguna-de-humantay.avif",
        },
        {
            dia: "TOUR VALLE SUR CUSCO",
            descripcion: [
                `El Tour Valle Sur Cusco es perfecto para quienes desean descubrir sitios arqueológicos, preincaicos e iglesias coloniales en una sola ruta. Visitaremos Tipón, un complejo hidráulico inca; Pikillacta, ciudad preinca de la cultura Wari; y la famosa Capilla Sixtina de Andahuaylillas, reconocida por sus impresionantes murales. El recorrido finaliza en la Plaza Mayor de Cusco.`
            ],
            incluye: ["Desayuno en el hotel", "Guía profesional", "Tickets de ingreso", "Transporte turístico con recojo en el hotel"],
            noIncluye: ["Alimentos no mencionados", "Ingreso a la Momia", "Gastos extras"],
            recomendaciones: [
                "Llevar DNI o pasaporte vigente",
                "Mochila pequeña",
                "Ropa abrigadora (según temporada)",
                "Aperitivos y agua para el camino",
                "Repelente y poncho de lluvia",
                "Dinero extra en soles"
            ],
            imagen: "/cusco/tour-valle-sur.avif",
        },
        {
            dia: "MORADA DE LOS DIOSES EN CUATRIMOTOS",
            descripcion: [
                `Vive una experiencia única con la aventura en cuatrimotos hacia la Morada de los Dioses. Tras una breve práctica, recorrerás los paisajes de Sencca hasta llegar a las esculturas monumentales que representan deidades andinas como la Pachamama, Wiracocha y el Portal del Sol. Finalizaremos en un mirador con vistas panorámicas de Cusco.`
            ],
            incluye: ["Desayuno en el hotel", "Guía profesional", "Tickets de ingreso", "Cuatrimotos", "Transporte turístico con recojo en el hotel"],
            ...
            imagen: "/cusco/morada-de-los-dioses-en-cuatrimoto.avif",
        },
        {
            ...
            imagen: "/cusco/aeropuerto-cusco.avif",
        }
    ],
    en: 
    [
        {
            ...
            descripcion: [
                `Airport or bus terminal reception: Upon arrival, our staff will be waiting for you with a company sign. The transfer, duly identified with their ID, will give you a brief explanation of the program while we transfer you to the hotel. Upon arrival, you will be greeted with a traditional coca tea while we check you in and escort you to your room for accommodation.`,
                `First Tour – Archaeological City Tour (Half Day): In the afternoon, we'll begin our first tour. The tour will pick you up from your hotel to visit Cusco's five most important archaeological sites. This tour lasts approximately five hours and includes:`,
            ],
            atractivos: [
        ...
        {
            dia: "SACRED VALLEY OF THE INCAS TOUR + MARAS AND MORAY",
            descripcion: [
        ...
        {
            dia: "HUMANTAY LAGOON TOUR",
            descripcion: [
                `Discover the magical Humantay Lagoon, one of Cusco's most visited natural gems. Our tour begins early with pickup from your hotel (4:30–5:00 a.m.) before heading to Mollepata, where we'll enjoy a buffet breakfast.`,
                `We'll then continue to Soraypampa (3,900 m), the starting point of the hike. The approximately 1 hour and 30-minute trek will take us to the impressive Humantay Lagoon (4,200 m), with its turquoise waters surrounded by the towering glaciers of the Andes Mountains. After the visit, we'll return to Mollepata for lunch before heading back to Cusco.`
            ],
            incluye: ["Round-trip tourist transportation", "Buffet breakfast and lunch", "Entrance tickets", "Professional bilingual guide"],
            noIncluye: ["Horse rental", "Personal expenses"],
            recomendaciones: [
                "Valid passport or ID",
                "Small backpack, water and snacks",
        ...
        {
            dia: "SOUTH VALLEY TOUR CUSCO",
            descripcion: [
                `The Cusco South Valley Tour is perfect for those who want to discover archaeological sites, pre-Incan sites, and colonial churches all in one trip. We'll visit Tipón, an Incan hydraulic complex; Pikillacta, a pre-Incan city of the Wari culture; and the famous Sistine Chapel of Andahuaylillas, renowned for its impressive murals. The tour ends in Cusco's Plaza Mayor.`
            ],
            incluye: ["Breakfast at the hotel", "Professional guide", "Entrance tickets", "Tourist transportation with hotel pick-up"],
            noIncluye: ["Foods not mentioned", "Entrance to the Mummy", "Extra expenses"],
            recomendaciones: [
                "Bring a valid ID or passport",
                "Small backpack",
                "Warm clothing (depending on the season)",
                "Snacks and water for the road",
                "Repellent and rain poncho",
                "Extra money in soles"
            ],
            imagen: "/cusco/tour-valle-sur.avif",
        },
        {
            dia: "ABODE OF THE GODS ON ATVS",
            descripcion: [
                `Enjoy a unique experience with an ATV adventure to the Abode of the Gods. After a brief practice session, you'll explore the Sencca landscape until you reach monumental sculptures representing Andean deities such as Pachamama, Wiracocha, and the Portal of the Sun. We'll finish at a viewpoint with panoramic views of Cusco.`
            ],
            incluye: ["Breakfast at the hotel", "Professional guide", "Entrance tickets", "ATVs", "Tourist transportation with hotel pick-up"],
